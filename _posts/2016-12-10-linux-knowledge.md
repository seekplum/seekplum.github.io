...
<ul>
<li>export s_10="%|10s" (说明: | 符号是为了防止转义，使用时需删除)</li>
<li>export d_10="%|10d" (说明: | 符号是为了防止转义，使用时需删除)</li>
<li>export f_10="%|10.2f" (说明: | 符号是为了防止转义，使用时需删除)</li>
<li>cat pay.txt | > awk ' NR==1{printf "s ${s_10} ${s_10} ${s_10} ${s_10}\n", $1, $2, $3, $4, "Total"}
NR>=2{total=$2+$3+$4;
printf "${s_10} ${d_10} ${d_10} ${d_10} ${f_10}\n", $1, $2, $3, $4, total}'</li>
</ul>
